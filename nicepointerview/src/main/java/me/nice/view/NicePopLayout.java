...
public class NicePopLayout extends FrameLayout implements View.OnLayoutChangeListener {


    public NicePopLayout(@NonNull Context context) {
        this(context, null);
    }

    public NicePopLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NicePopLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.NicePopLayout);

        mSiteMode = a.getInt(R.styleable.NicePopLayout_siteMode, SITE_BOTTOM);
        mRadiusSize = a.getDimensionPixelSize(R.styleable.NicePopLayout_radiusSize,
                getResources().getDimensionPixelSize(R.dimen.nv_dp_10));
        mBulgeSize = a.getDimensionPixelSize(R.styleable.NicePopLayout_bulgeSize,
                getResources().getDimensionPixelSize(R.dimen.nv_dp_10));
        mOffset = a.getDimensionPixelSize(R.styleable.NicePopLayout_offsetSize, 0);
        a.recycle();
    ...
    private void resetMask() {
        ...
        mPopMaskPath.addRoundRect(new RectF(mBulgeSize, mBulgeSize, width - mBulgeSize,
                height - mBulgeSize), mRadiusSize, mRadiusSize, Path.Direction.CCW);
